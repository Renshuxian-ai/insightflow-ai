...
export function AnomalyCard({ anomaly }: AnomalyCardProps) {
  ...
  return (
    <article className="rounded-lg border border-[#e9ecf1] p-3 transition-colors hover:border-[#d8def0]">
      ...
      <p className="mt-1 line-clamp-2 text-xs leading-5 text-[#7e8798]">
