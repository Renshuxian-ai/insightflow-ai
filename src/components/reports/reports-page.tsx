          ...
          <div className="border-t border-[#eef0f4] pt-4">
            ...
            <div className="mt-4 flex flex-wrap justify-end gap-2">
              ...
              <Link
                ...
                className="inline-flex h-9 w-fit items-center gap-1.5 rounded-lg border border-[#d9dee8] bg-white px-3.5 text-xs font-semibold text-[#526078] transition-colors hover:border-[#c4ccda] hover:bg-[#fafbfc] hover:text-[#263247] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3559e8]/25"
              >
                View report
                <ArrowIcon />
              </Link>
...
export function ReportsPage({
  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] px-5 py-7 sm:px-7 lg:px-10 lg:py-9">
      ...
      <section className="mt-6" aria-label="Report statistics">
      ...
      <section className="mt-6" aria-labelledby="report-library-title">
